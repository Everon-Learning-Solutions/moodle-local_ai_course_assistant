...
$string['privacy:metadata:local_ai_course_assistant_msgs:model_name'] = '用于回复的 AI 模型。';
$string['privacy:metadata:local_ai_course_assistant_msgs:provider'] = '用于回复的 AI 提供商。';
...
$string['settings:systemprompt_desc'] = '发送给 AI 的系统提示。可使用占位符：{{coursename}}、{{userrole}}、{{coursetopics}}、{{institution}}。';
$string['settings:systemprompt_default'] = '你是 SOLA（在线学习助手），为选修「{{coursename}}」的 {{institution}} 学生提供学习的 AI 辅导。学生角色为 {{userrole}}。
...
$string['settings:institution_name_desc'] = '在系统提示、头像标签和示例内容中显示的机构名称。更换品牌时请修改此项。';
...
$string['chat:greeting'] = '你好，{$a}！我是 SOLA，你的在线学习助手。';
...
// Practice Scoring.
$string['rubric:score_title_conversation'] = '对话练习得分';
$string['rubric:score_title_pronunciation'] = '发音练习得分';
$string['rubric:overall'] = '总体';
$string['rubric:practice_again'] = '再练一次';
$string['rubric:done'] = '完成';
$string['rubric:scoring'] = '正在评估你的练习…';
$string['rubric:encourage_high'] = '很棒！继续保持！';
$string['rubric:encourage_mid'] = '不错！多练习会更好。';
$string['rubric:encourage_low'] = '开了个好头！坚持练习会有进步。';
...
$string['integrity:email_desc'] = '失败报告的接收邮箱，多个地址用逗号分隔。留空则通知主站管理员。';
...
$string['privacy:metadata:local_ai_course_assistant_feedback'] = '存储用户反馈与评分。';
$string['privacy:metadata:local_ai_course_assistant_feedback:userid'] = '提交反馈的用户 ID。';
$string['privacy:metadata:local_ai_course_assistant_feedback:courseid'] = '反馈所属课程。';
$string['privacy:metadata:local_ai_course_assistant_feedback:rating'] = '给出的数字评分。';
$string['privacy:metadata:local_ai_course_assistant_feedback:comment'] = '反馈评论文本。';
...
$string['privacy:metadata:local_ai_course_assistant_feedback:user_agent'] = '浏览器 User-Agent 字符串。';
$string['privacy:metadata:local_ai_course_assistant_feedback:page_url'] = '提交反馈时的页面 URL。';
$string['privacy:metadata:local_ai_course_assistant_feedback:timecreated'] = '反馈提交时间。';
$string['privacy:metadata:local_ai_course_assistant_survey_resp'] = '存储学生的问卷回复。';
$string['privacy:metadata:local_ai_course_assistant_survey_resp:userid'] = '回复问卷的用户 ID。';
$string['privacy:metadata:local_ai_course_assistant_survey_resp:courseid'] = '问卷所属课程。';
$string['privacy:metadata:local_ai_course_assistant_survey_resp:question_index'] = '所答问题的索引。';
$string['privacy:metadata:local_ai_course_assistant_survey_resp:answer'] = '答案文本或选项。';
$string['privacy:metadata:local_ai_course_assistant_survey_resp:timecreated'] = '回复提交时间。';
$string['privacy:metadata:local_ai_course_assistant_ut_resp'] = '存储可用性测试回复。';
$string['privacy:metadata:local_ai_course_assistant_ut_resp:userid'] = '完成测试的用户 ID。';
$string['privacy:metadata:local_ai_course_assistant_ut_resp:courseid'] = '可用性测试所属课程。';
$string['privacy:metadata:local_ai_course_assistant_ut_resp:task_index'] = '完成的任务索引。';
$string['privacy:metadata:local_ai_course_assistant_ut_resp:rating'] = '该任务给出的数字评分。';
$string['privacy:metadata:local_ai_course_assistant_ut_resp:answer'] = '该任务的自由文本回复。';
$string['privacy:metadata:local_ai_course_assistant_ut_resp:timecreated'] = '回复提交时间。';
$string['privacy:metadata:local_ai_course_assistant_audit'] = '存储合规追踪的审计日志条目。';
$string['privacy:metadata:local_ai_course_assistant_audit:userid'] = '被记录操作的用户 ID。';
$string['privacy:metadata:local_ai_course_assistant_audit:courseid'] = '操作的课程上下文。';
$string['privacy:metadata:local_ai_course_assistant_audit:action'] = '执行的操作。';
$string['privacy:metadata:local_ai_course_assistant_audit:ipaddress'] = '用户 IP 地址。';
$string['privacy:metadata:local_ai_course_assistant_audit:useragent'] = '浏览器 User-Agent 字符串。';
$string['privacy:metadata:local_ai_course_assistant_audit:details'] = '操作的其他详情。';
$string['privacy:metadata:local_ai_course_assistant_audit:timecreated'] = '操作记录时间。';
$string['privacy:metadata:local_ai_course_assistant_practice_scores'] = '存储练习会话得分与 AI 反馈。';
$string['privacy:metadata:local_ai_course_assistant_practice_scores:userid'] = '完成练习的用户 ID。';
$string['privacy:metadata:local_ai_course_assistant_practice_scores:courseid'] = '练习会话所属课程。';
$string['privacy:metadata:local_ai_course_assistant_practice_scores:session_type'] = '练习会话类型（对话或发音）。';
$string['privacy:metadata:local_ai_course_assistant_practice_scores:overall_score'] = '获得的总体得分。';
$string['privacy:metadata:local_ai_course_assistant_practice_scores:scores'] = '按维度的得分（JSON 格式）。';
$string['privacy:metadata:local_ai_course_assistant_practice_scores:ai_feedback'] = '练习会话的 AI 生成反馈。';
$string['privacy:metadata:local_ai_course_assistant_practice_scores:timecreated'] = '得分记录时间。';

// AI Insights.
$string['insights:title'] = 'AI 洞察';
$string['insights:desc'] = '分析反馈、问卷与可用性测试数据，发现问题、功能需求与建议。';
$string['insights:generate'] = '生成 AI 洞察';
$string['insights:generating'] = '正在分析数据…请稍候。';
$string['insights:no_data'] = '暂无可供分析的反馈、问卷或可用性测试数据。用户提交反馈或完成问卷后即可生成洞察。';
...
$string['error_rate_limit_ip'] = '来自您 IP 的请求过多，请稍后再试。';
$string['error_rate_limit_user'] = '请求过多，请稍后再试。';
$string['error_no_tts_key'] = '未配置 TTS 用 OpenAI API 密钥。';

// Reminder validation errors.
$string['error_reminders_email_disabled'] = '未启用电子邮件提醒。';
$string['error_reminders_whatsapp_disabled'] = '未启用 WhatsApp 提醒。';
$string['error_reminders_whatsapp_country_blocked'] = '您所在国家/地区不可用 WhatsApp 提醒。';
